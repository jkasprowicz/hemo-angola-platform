        ...
        row.trace_records.append(
            {
                ...
                "collection_date": version.submission.collection_date.isoformat() if version.submission.collection_date else None,
                "closed_at": version.submission.closed_at.isoformat() if version.submission.closed_at else None,
                "submitted_at": version.submission.submitted_at.isoformat() if version.submission.submitted_at else None,
